...
from schemas.song_schema import SongCreate, SongUpdate, SongResponse
...
@router.get("/id/{song_id}", response_model=SongResponse)
...
@router.get("/ref/{refNo}", response_model=SongResponse)
